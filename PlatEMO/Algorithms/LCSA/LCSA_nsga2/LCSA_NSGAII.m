...
% ----------------------------------------------------------------------- 
    ...
    [~,FrontNo,CrowdDis] = LCSA_NSGAIIEnvironmentalSelection(Population,Global.N);
    ...
    while Global.NotTermination(Population)
        ...
        [Population,FrontNo,CrowdDis] = LCSA_NSGAIIEnvironmentalSelection([Population,Offspring],Global.N);
        ...
        if mod(iter,xintervall) == 0
            ...
            [~,xFrontNo,xCrowdDis] = LCSA_NSGAIIEnvironmentalSelection(xPop,Global.N);
            [Population,~,~] = LCSA_NSGAIIEnvironmentalSelection([Population,xPop],Global.N);
            ...
            for temp = 1:noOfXOptGenerations 
                ...
                Global.NotTermination(Population);
                xMatingPool = TournamentSelection(2,Global.N,xFrontNo,-xCrowdDis);
                ...
                [xPop,xFrontNo,xCrowdDis] = LCSA_NSGAIIEnvironmentalSelection([xPop,newSols],Global.N);
                [Population,FrontNo,CrowdDis] = LCSA_NSGAIIEnvironmentalSelection([Population,xPop],Global.N);
