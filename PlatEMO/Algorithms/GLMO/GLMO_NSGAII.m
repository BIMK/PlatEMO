function GLMO_NSGAII(Global, numberOfGroups, typeOfGroups)
% ----------------------------------------------------------------------- 
...
% ----------------------------------------------------------------------- 
    ...
    [~,FrontNo,CrowdDis] = GLMO_NSGAIIEnvironmentalSelection(Population,Global.N);

    %% Optimization
    while Global.NotTermination(Population)
        MatingPool = TournamentSelection(2,Global.N,FrontNo,-CrowdDis);
        Offspring  = GLMO_GA(Population(MatingPool), numberOfGroups, typeOfGroups);
        [Population,FrontNo,CrowdDis] = GLMO_NSGAIIEnvironmentalSelection([Population,Offspring],Global.N);
    end
end