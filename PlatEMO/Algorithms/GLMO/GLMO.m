function GLMO(Global)
% <algorithm> <G>
% Grouped and Linked Mutation Operator Algoritms for Large-scale Optimisation
...
% -----------------------------------------------------------------------
    ...
    [optimiser,typeOfGroups,numberOfGroups] = Global.ParameterSet(3,2,4);

    if optimiser == 1
        GLMO_SMPSO(Global, numberOfGroups, typeOfGroups);
    elseif optimiser == 2
        GLMO_NSGAII(Global, numberOfGroups, typeOfGroups);
    else
        GLMO_NSGAIII(Global, numberOfGroups, typeOfGroups);
    end
