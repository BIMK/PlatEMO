function candidates = MOEAOptimize(subproblemList,popSize,maxIter)
...
%--------------------------------------------------------------------------
    ...
    population.decs = lhsdesign(popSize,D).*repmat(BU-BD,popSize,1) + repmat(BD,popSize,1);
    population.objs = SaEvaluate(subproblemList,population.decs);
