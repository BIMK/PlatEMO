function PopDec = InfillSamplingEIM(Problem,KrigingModel,PopObjScaled,InfillCriterionIndex)
...
% This function is written by Dawei Zhan
    ...
    Offspring   = repmat(Problem.upper-Problem.lower,GAPopulationSize,1).*UniformPoint(GAPopulationSize,D,'Latin')+repmat(Problem.lower,GAPopulationSize,1);
