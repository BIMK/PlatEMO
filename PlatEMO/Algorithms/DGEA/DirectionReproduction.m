function Offspring = DirectionReproduction(Global,Population,FrontNo,RefNo)
...
% This function is written by Cheng He
	...
	subN    = max([floor(Global.N/RefNo),10]);
    Lower   = repmat(Global.lower,subN,1);
    Upper   = repmat(Global.upper,subN,1);
    PopDec  = [];
