...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function obj = GUI()
            ...
            obj.app.figure   = uifigure('Name','PlatEMO v3.0','Position',[0 0 1200 650],'Interruptible','off','icon',fullfile(obj.iconFolder,'logo1.png'),'BusyAction','cancel','Visible','off','WindowButtonMotionFcn',@(~,~)[]);
            ...
            obj.app.button(2) = GUI.APP([1 2],3,uibutton(obj.app.grid(2),'Text',{'Application','Module'},'VerticalAlignment','bottom','FontSize',11,'Icon',fullfile(obj.iconFolder,'application.png'),'IconAlignment','top','Tooltip',{'Use algorithms to solve your own problem.','You can design your own problem, save it as a .m file, and solve it by the suggested algorithms.'},'ButtonpushedFcn',{@obj.cb_module,2}));
