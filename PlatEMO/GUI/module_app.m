...
%--------------------------------------------------------------------------
    ...
    methods(Access = ?GUI)
        ...
        function obj = module_app(GUI)
            ...
            obj.app.dropA      = GUI.APP([1 3],4,uidropdown(obj.app.grid(1),'BackgroundColor',[.95 .95 1],'Tooltip','Select predefined examples','Items',{'User-defined problem','Single-objective problem','Multi-objective problem','Many-objective problem','Constrained single-objective problem','Constrained multi-objective problem','Rotated optimization problem','Integer optimization problem','Binary optimization problem','Permutation optimization problem'},'ItemsData',1:10,'Value',1,'Interruptible','off','BusyAction','cancel','ValueChangedFcn',@obj.cb_selectProblem));
            ...
            obj.app.labelB(2)   = GUI.APP(2,[4 6],uilabel(obj.app.grid(2),'Text','variables'));
            obj.app.labelB(3)   = GUI.APP(3,1,uilabel(obj.app.grid(2),'Text','e.g.  x =','HorizontalAlignment','right'));
            obj.app.labelB(4)   = GUI.APP(3,[2 6],uilabel(obj.app.grid(2),'Text',['(',num2str(rand(1,10),'% .1f'),')']));
            % Decision space
            ...
            obj.app.buttonB(3)  = GUI.APP(8,5,uibutton(obj.app.grid(2),'Text','...','Tooltip','Load existing dataset','BackgroundColor','w','ButtonpushedFcn',{@obj.cb_loadFunction,obj.app.editB(4),{'*.txt','Text file';'*.dat','Text file';'*.csv','Text file';'*.mat','MAT file'}}));
            % Initialization function
            tempGrid            = GUI.APP(9,[1 6],uigridlayout(obj.app.grid(2),'RowHeight',{'1x'},'ColumnWidth',{133,30,30,'1x'},'Padding',[0 0 0 6],'RowSpacing',0,'ColumnSpacing',5,'BackgroundColor','w'));
            ...
            % Repair function
            tempGrid            = GUI.APP(11,[1 6],uigridlayout(obj.app.grid(2),'RowHeight',{'1x'},'ColumnWidth',{100,30,30,'1x'},'Padding',[0 0 0 6],'RowSpacing',0,'ColumnSpacing',5,'BackgroundColor','w'));
            ...
            obj.app.buttonB(9)  = GUI.APP(1,3,uibutton(tempGrid,'Text','Del','Enable','off','FontSize',10,'Tooltip','Delete the repair function','BackgroundColor','w','ButtonpushedFcn',{@obj.cb_updateProblem,-3}));
            ...
            obj.app.buttonB(10) = GUI.APP(12,5,uibutton(obj.app.grid(2),'Text','...','Tooltip','Load existing function','BackgroundColor','w','ButtonpushedFcn',{@obj.cb_loadFunction,obj.app.editB(6),{'*.m','MATLAB function'}}));
            obj.app.buttonB(11) = GUI.APP(12,6,uibutton(obj.app.grid(2),'Text','+','Fontsize',15,'Tooltip','Create new function','BackgroundColor','w','ButtonpushedFcn',{@obj.cb_createFunction,obj.app.editB(6),'repair'}));
            % Objective functions
            tempGrid            = GUI.APP(13,[1 6],uigridlayout(obj.app.grid(2),'RowHeight',{'1x'},'ColumnWidth',{123,30,30,'1x'},'Padding',[0 0 0 6],'RowSpacing',0,'ColumnSpacing',5,'BackgroundColor','w'));
            ...
            obj.app.buttonB(12) = GUI.APP(1,2,uibutton(tempGrid,'Text','Add','FontSize',10,'Tooltip','Add an objective function','BackgroundColor','w','ButtonpushedFcn',{@obj.cb_updateProblem,4}));
            obj.app.buttonB(13) = GUI.APP(1,3,uibutton(tempGrid,'Text','Del','Enable','off','FontSize',10,'Tooltip','Delete the last objective function','BackgroundColor','w','ButtonpushedFcn',{@obj.cb_updateProblem,-4}));
            ...
            tempGrid            = GUI.APP(34,[1 6],uigridlayout(obj.app.grid(2),'RowHeight',{'1x'},'ColumnWidth',{130,30,30,'1x'},'Padding',[0 0 0 6],'RowSpacing',0,'ColumnSpacing',5,'BackgroundColor','w'));
            ...
            obj.app.buttonB(14) = GUI.APP(1,2,uibutton(tempGrid,'Text','Add','FontSize',10,'Tooltip','Add a constraint function','BackgroundColor','w','ButtonpushedFcn',{@obj.cb_updateProblem,5}));
            obj.app.buttonB(15) = GUI.APP(1,3,uibutton(tempGrid,'Text','Del','FontSize',10,'Tooltip','Delete the last constraint function','BackgroundColor','w','ButtonpushedFcn',{@obj.cb_updateProblem,-5}));
            ...
            obj.app.checkB(5)   = GUI.APP(60,[1 6],uicheckbox(obj.app.grid(2),'FontSize',11,'Text','<preference> Only searching for preferred regions of the Pareto front.','WordWrap','on','ValueChangedFcn',@obj.cb_updateFilter));
            ...
            % The fourth panel
            obj.app.grid(4) = GUI.APP([2 3],6,uigridlayout(obj.app.maingrid,'RowHeight',{'1x',40,30},'ColumnWidth',{20,150,'1x','1x',120,30,20},'Padding',[15 10 15 0],'RowSpacing',5,'BackgroundColor','w'));
            obj.app.axes    = GUI.APP(1,[2 6],uiaxes(obj.app.grid(4),'BackgroundColor','w','Box','on'));
            obj.app.waittip = GUI.APP(1,[2 6],uilabel(obj.app.grid(4),'HorizontalAlignment','center','Text','                 Please wait ... ...','Visible','off'));
            ...
            obj.app.buttonD(3) = GUI.APP(3,[6 7],uibutton(obj.app.grid(4),'push','Text','Save','FontSize',16,'Enable','off','ButtonpushedFcn',@obj.cb_save));
    ...
    methods(Access = private)
        ...
        function cb_updateProblem(obj,~,~,index,noFlush)
            switch index
                ...
                case {4,-4}     % Objective functions
                    ...
                    obj.app.buttonB(12).Enable       = length(obj.pro) < 20;
                    obj.app.buttonB(13).Enable       = length(obj.pro) > 1;
                case {5,-5}     % Constraint functions
                    ...
                    obj.app.buttonB(14).Enable       = length(obj.con) < 20;
                    obj.app.buttonB(15).Enable       = length(obj.con) > 0;
            end
            if nargin < 5 || ~noFlush
                obj.cb_updateFilter();
            end
        ...
        function cb_selectProblem(obj,~,~)
            if obj.app.dropA.Value == 1
                ...
                switch obj.app.dropA.Value
                    ...
                    case 8
                        Str = {40,'real','zeros(1,40)','zeros(1,40)+10','','','max(min(round(x),10),0)','mean(x.^2)',''};
                    case 9
        ...
        %% Load existing dataset or function
                ...
                try
                    ...
                    switch type
                        case 'initialization'
                            ...
                            if obj.app.grid(2).RowHeight{8} > 0
                                fprintf(fid,'%% Input ''data'' can be any type of user-defined dataset\n');
                            end
