...
%--------------------------------------------------------------------------
    ...
    methods
        %% Initialization
        function obj = Sparse_PM()
            % Parameter setting
            [numTran,lenTran,numPa,lenPa,numItem] = obj.Global.ParameterSet(10000,50,100,5,100);
            obj.Global.M        = 2;
            obj.Global.D        = numItem;
        ...
        function PopDec = Init(obj,N)
            PopDec = rand(N,obj.Global.D) < 20/obj.Global.D;
        end
