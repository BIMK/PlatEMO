classdef NI_HS < PROBLEM
% <single> <real> <large/none> <multitask>
% Multitasking problem (Rosenbrock function + Rastrigin function)
...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function Setting(obj)
            ...
            obj.L1       = zeros(1,obj.SubD(1)) - 30;
            obj.U1       = zeros(1,obj.SubD(1)) + 30;
        ...
        function PopObj = CalObj(obj,PopDec)
            ...
            for i = 1 : size(PopDec,1)
                if PopDec(i,end) == 1       % Task 1
                    ...
                    PopObj(i) = sum(100*(x1(2:end)-x1(1:end-1).^2).^2+(x1(1:end-1)-1).^2,2);
