...
% This functions is written by Saeid Kazemzadeh Azad
    ...
    methods
        ...
        function Setting(obj)
            obj.M = 1;
            obj.D = 328;     
            obj.lower    = [ones(1,314),9000,9000,9000,9000,9000,9000,9000,9000,9000,9000,9000,9000,9000,9000]; 
            obj.upper    = [37*ones(1,314),20000,20000,20000,20000,20000,20000,20000,20000,20000,20000,20000,20000,20000,20000];
        ...
        function Population = Evaluation(obj,varargin)
            ...
            for i = 1 : size(X,1)
                [PopObj(i,1),PopCon(i,1),PopCon(i,2)] = ISCSO_2018(X(i,1:314),X(i,315:328),0); 
            end
