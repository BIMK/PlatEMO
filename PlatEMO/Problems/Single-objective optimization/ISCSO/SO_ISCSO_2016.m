classdef SO_ISCSO_2016 < PROBLEM
...
% This functions is written by Saeid Kazemzadeh Azad
    ...
    methods
        ...
        function Setting(obj)
            obj.M = 1;
            obj.D = 124;     
            obj.lower    = [ones(1,117),1000,1000,1000,1000,1000,1000,1000]; 
            obj.upper    = [37*ones(1,117),3500,3500,3500,3500,3500,3500,3500];
        ...
        function Population = Evaluation(obj,varargin)
            ...
            for i = 1 : size(X,1)
                [PopObj(i,1),PopCon(i,1),PopCon(i,2)] = ISCSO_2016(X(i,1:117),X(i,118:124),0); 
            end
