classdef SO_ISCSO_2019 < PROBLEM
...
% This functions is written by Saeid Kazemzadeh Azad
    ...
    methods
        ...
        function Setting(obj)
            obj.M = 1;
            obj.D = 270;     
            obj.lower    = [ones(1,260),-25000,-25000,-25000,-25000,-25000,-25000,-25000,-25000,-25000,-25000]; 
            obj.upper    = [37*ones(1,260),3500,3500,3500,3500,3500,3500,3500,3500,3500,3500];
        ...
        function Population = Evaluation(obj,varargin)
            ...
            for i = 1 : size(X,1)
                [PopObj(i,1),PopCon(i,1),PopCon(i,2)] = ISCSO_2019(X(i,1:260),X(i,261:270),0); 
            end
