classdef SO_ISCSO_2017 < PROBLEM
...
% This functions is written by Saeid Kazemzadeh Azad
    ...
    methods
        ...
        function Setting(obj)
            obj.M = 1;
            obj.D = 211;     
            obj.lower    = [ones(1,198),25000,25000,25000,25000,25000,25000,-12000,-12000,-12000,-12000,-12000,-12000,-12000];  
            obj.upper    = [37*ones(1,198),35000,35000,35000,35000,35000,35000,3000,3000,3000,3000,3000,3000,3000];
        ...
        function Population = Evaluation(obj,varargin)
            ...
            for i = 1 : size(X,1)
                [PopObj(i,1),PopCon(i,1),PopCon(i,2)] = ISCSO_2017(X(i,1:198),X(i,199:211),0); 
            end
