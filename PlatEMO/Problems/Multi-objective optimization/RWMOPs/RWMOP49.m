classdef RWMOP49 < PROBLEM
% <multi> <real> <constrained>
% Optimal droop setting for minimizing voltage deviation, active, and reactive power loss
...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function R = GetOptimum(obj,~)
            R = [1.4253454e-01   2.0364141e-02   5.8302635e-04];
        end
    end
end
