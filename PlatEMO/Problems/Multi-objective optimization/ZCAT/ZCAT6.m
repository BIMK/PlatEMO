...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function PopObj = CalObj(obj,PopDec)
            ...
            A = repmat((1:obj.M).^2,size(y,1),1).*[y(:,1:obj.M-1),(1./(1+exp(80*mean(y(:,1:obj.M-1),2)-40))-0.05*mean(y(:,1:obj.M-1),2)-1./(1+exp(40))+0.05)./(1./(1+exp(-40))-1./(1+exp(40))+0.05)];
        ...
        function R = GetOptimum(obj,N)
            ...
            R = [x,(1./(1+exp(80*mean(x,2)-40))-0.05*mean(x,2)-1./(1+exp(40))+0.05)./(1./(1+exp(-40))-1./(1+exp(40))+0.05)];
        ...
        function R = GetPF(obj)
            ...
            elseif obj.M == 3
                ...
                R     = {x,4*y,9*(1./(1+exp(40*(x+y)-40))-0.025*(x+y)-1./(1+exp(40))+0.05)./(1./(1+exp(-40))-1./(1+exp(40))+0.05)};
            else
                R = [];
            end
        end
