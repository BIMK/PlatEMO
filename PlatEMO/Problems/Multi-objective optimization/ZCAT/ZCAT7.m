...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function PopObj = CalObj(obj,PopDec)
            ...
            A = repmat((1:obj.M).^2,size(y,1),1).*[y(:,1:obj.M-1),mean((0.5-y(:,1:obj.M-1)).^5,2)/2/0.5^5+1/2];
        ...
        function R = GetOptimum(obj,N)
            ...
            R = [x,mean((0.5-x).^5,2)/2/0.5^5+1/2];
        ...
        function R = GetPF(obj)
            ...
            elseif obj.M == 3
                ...
                R     = {x,4*y,9*(((0.5-x).^5+(0.5-y).^5)/4/0.5^5+1/2)};
            else
                R = [];
            end
        end
