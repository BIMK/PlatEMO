...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function PopObj = CalObj(obj,PopDec)
            ...
            A = 1 - fliplr(cumprod(1-y(:,1:obj.M-1),2)).*[ones(size(y,1),1),y(:,obj.M-1:-1:2)];
        ...
        function R = GetOptimum(obj,N)
            ...
            R = 1 - fliplr(cumprod(1-x,2)).*[ones(size(x,1),1),x(:,end:-1:2)];
        ...
        function R = GetPF(obj)
            ...
            elseif obj.M == 3
                ...
                R = {1-(1-x).*(1-y),4-4*(1-x).*y,9*(cos(5*pi*x)+2*x+12*(1-x)-1)/12};
