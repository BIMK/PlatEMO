...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function PopObj = CalObj(obj,PopDec)
            ...
            A = fliplr(cumsum([zeros(size(y,1),1),y(:,1:obj.M-1)],2)) + [zeros(size(y,1),1),1-y(:,obj.M-1:-1:1)];
        ...
        function R = GetOptimum(obj,N)
            ...
            R = fliplr(cumsum([zeros(size(x,1),1),x],2)) + [zeros(size(x,1),1),1-x(:,end:-1:1)];
