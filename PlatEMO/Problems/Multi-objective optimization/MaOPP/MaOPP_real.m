...
% jens.weise@ovgu.de
    ...
    methods
        ...
        function setRealEncoding(obj)
            obj.D        = (obj.x_max + obj.y_max - 2)*obj.overheadVariablesFactor;
            obj.lower    = zeros(1,obj.D);
            obj.upper    = ones(1,obj.D);
            obj.encoding = ones(1,obj.D);
        end
        function [x_coords, y_coords,D] = decodePath(obj,PopDec,x_max,y_max)
        	[x_coords, y_coords, D] = decodePathWithRealValues(obj,PopDec,x_max,y_max);
        end
