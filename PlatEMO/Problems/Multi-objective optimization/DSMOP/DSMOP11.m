...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function PopObj = CalObj(obj,X)
            ...
            g = sum(g1(X(:,obj.M:end),pi/3).*g2(X(:,obj.M:end),0),2) + abs(obj.K-sum(X(:,obj.M:end)~=0,2));
