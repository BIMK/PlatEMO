...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function PopObj = CalObj(obj,X)
            ...
            g = sum(g1(X(:,obj.M:obj.M+obj.K-1),0.25+0.75*sin(0.5*pi*t)),2);
            for i = 1 : ceil((obj.D-obj.M-obj.K+1)/10)
                temp = 50 - sum(g1(X(:,obj.M+obj.K+(i-1)*10:min(obj.M+obj.K+i*10-1,end)),0),2);
