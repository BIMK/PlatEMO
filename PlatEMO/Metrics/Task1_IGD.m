function score = Task1_IGD(Population,optimum)
% <min> <multi/many> <real/integer/label/binary/permutation> <large/none> <constrained/none> <expensive/none> <sparse/none> <multitask>
% Inverted generational distance of the first task (for multitask optimization)
...
%--------------------------------------------------------------------------
    ...
    PopObj = Population(PopDec(:,end)==1).best.objs;
